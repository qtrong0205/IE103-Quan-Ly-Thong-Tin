...
-- Thay the <DUONG_DAN_THU_MUC> bang duong dan tuyet doi chua cac file CSV
...
FROM '<DUONG_DAN_THU_MUC>SANBAY.csv'
WITH (
    FIRSTROW       = 2,
    FIELDTERMINATOR = ',',
    ROWTERMINATOR  = '0x0a',
...
FROM '<DUONG_DAN_THU_MUC>HANGHANGKHONG.csv'
WITH (
    FIRSTROW       = 2,
    FIELDTERMINATOR = ',',
    ROWTERMINATOR  = '0x0a',
...
FROM '<DUONG_DAN_THU_MUC>LOAIMAYBAY.csv'
WITH (
    FIRSTROW       = 2,
    FIELDTERMINATOR = ',',
    ROWTERMINATOR  = '0x0a',
...
FROM '<DUONG_DAN_THU_MUC>MAYBAY.csv'
WITH (
    FIRSTROW       = 2,
    FIELDTERMINATOR = ',',
    ROWTERMINATOR  = '0x0a',
...
FROM '<DUONG_DAN_THU_MUC>CHUYENBAY.csv'
WITH (
    FIRSTROW       = 2,
    FIELDTERMINATOR = ',',
    ROWTERMINATOR  = '0x0a',
...
FROM '<DUONG_DAN_THU_MUC>NHANVIEN.csv'
WITH (
    FIRSTROW       = 2,
    FIELDTERMINATOR = ',',
    ROWTERMINATOR  = '0x0a',
...
FROM '<DUONG_DAN_THU_MUC>HANHKHACH.csv'
WITH (
    FIRSTROW        = 2,
    FIELDTERMINATOR = ',',
    ROWTERMINATOR   = '0x0a',
...
FROM '<DUONG_DAN_THU_MUC>LICHBAY.csv'
WITH (
    FIRSTROW       = 2,
    FIELDTERMINATOR = ',',
    ROWTERMINATOR  = '0x0a',
...
FROM '<DUONG_DAN_THU_MUC>BANGPHANCONG.csv'
WITH (
    FIRSTROW       = 2,
    FIELDTERMINATOR = ',',
    ROWTERMINATOR  = '0x0a',
...
FROM '<DUONG_DAN_THU_MUC>BANGGIAVE.csv'
WITH (
    FIRSTROW       = 2,
    FIELDTERMINATOR = ',',
    ROWTERMINATOR  = '0x0a',
...
FROM '<DUONG_DAN_THU_MUC>HANHLY.csv'
WITH (
    FIRSTROW       = 2,
    FIELDTERMINATOR = ',',
    ROWTERMINATOR  = '0x0a',
